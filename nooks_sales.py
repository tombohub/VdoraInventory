...
def get_sales():
    """
    get the list of the most recent sales from Nooks

    Returns:
    dict: sales (orders) from Nooks
    """

    # url to submit form and get cookies
    url = 'http://sell.thenooks.ca/index.php?p=login_process&sid=17352'

    # form submit data - login credentials
    form_data = {
